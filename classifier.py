...
class Classification(BaseModel):
    ...
    topic: str = Field(
        ...
        enum=["sports", "politics", "entertainment", "technology", "other"]
    )
...
def create_prompt_template() -> ChatPromptTemplate:
    ...
    return ChatPromptTemplate.from_messages(
        [
            ("system", 
             "You are an expert in classifying text based on the topic. \
             If topic is not clear, please classify it as 'other'. \
